...
- **Three sample rows** (2024 edition, table 25.79 "APPREL", p.236): `United States: 2020=1649.27 2021=2082.60 2022=2300.24 2023=1782.72 2024=1875.85`; `United Kingdom: 2020=562.60 2021=660.11 2022=700.15 2023=614.62 2024=660.10`; `Italy: 2020=360.59 2021=434.74 2022=508.86 2023=562.39 2024=471.96` (all USD Mn). Corrected 2026-09-12: this note previously labelled the columns 2019-2023 (with a fabricated 2019 figure for each market that doesn't appear anywhere in the real table) — off by one against the actual 2020-2024 header, confirmed by re-reading the PDF page directly. The connector itself was never affected: `to_fact_trade` derives each column's year from `latest_year - offset` (`edition_year=2024` here), which already lines up with the real 2020-2024 header — this was a documentation-only error, caught while building `tests/kg/test_spotcheck.py`.
